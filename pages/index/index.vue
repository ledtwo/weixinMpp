    ...
    <view>
        ...
        <view class="bigbox">
            ...
            <view class="bindsqun" v-if="showmore">
                <view class="bindsone dis-jasc" v-for="(item, index) in userList" :key="index">
                    <view class="onelist dis-alicen">
                        <view class="listimg dis-jacc"><image :src="item.thumb"></image></view>
                    ...
                    <view class="oncerig" @click="loginOut(item)"><image src="../../static/tui.png"></image></view>
                </view>
            </view>
        ...
        <view v-if="current == 2">
            <view class="lists">
                <view style="text-align: center" v-show="betList.length == 0">暂无数据</view>

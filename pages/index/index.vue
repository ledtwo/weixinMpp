<template>
	<view>
		...
		<view class="friends dis-alicen" v-for="(item,index) in jifenlist" :key="index">
			<view class="imgs">
				<image :src="item.userVO.thumb"></image>
			</view>
			<view class="fright">
		...
		<view class="utabs">
			<u-tabs :list="list" :is-scroll="false" :current="current" height="100" font-size="30" active-color="#9791E9"
				inactive-color="#949A9A" bg-color="#F7FCFF" bar-width="72" bar-height="8" @change="change"></u-tabs>
		</view>
		 	...
		 	<view class="listone dis-alicen" v-for="(item,index) in lastlists" :key="index" @longpress="showalert(index)">
				...
				<view class="onecont">
					...
					<view class="onebot dis-jasc">
						...
						<view class="botright"><text>{{item.integral}}</text>积分</view>
					</view>
				</view>
		 	</view>
		 	...
		 	<u-popup v-model="showxia" mode="center" border-radius="20" :closeable="true" close-icon-color="#fff" >
		 		<view class="showpop">
		 			...
		 			<scroll-view scroll-y="true">
		 				<view v-for="(item,index) in 56" :key="index">2XX6</view>
		 			</scroll-view>
		 		</view>
		 	</u-popup>
		</view>
		...
		<u-popup v-model="showuser" mode="center" border-radius="20" :closeable="true" close-icon-color="#fff" >
		 	<view class="showpop">
				...
				<view class="msguser" v-if="usersnum==1">
					<view class="usehead dis-jacc">
						<image :src="suijimg"></image>
					</view>
